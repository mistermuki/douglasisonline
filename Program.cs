...
namespace douglasisonline
{
    class Program
    {
        ...
        public string f_word1;
        public string f_word2;
        public string f_word3;
        public string f_word4;
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                string[] sentences = File.ReadAllLines("Y:/Doug/sentence.txt");
                string[] noun = File.ReadAllLines("Y:/Doug/noun.txt");
                string[] verb = File.ReadAllLines("Y:/Doug/verb.txt");
                string[] adj = File.ReadAllLines("Y:/Doug/adjective.txt");
                ...
                {
                    //Console.WriteLine(sentence_struct);
